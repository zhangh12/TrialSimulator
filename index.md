...
- Examples: crossover
  ...
  - [Crossover at
    milestone](https://zhangh12.github.io/TrialSimulator/articles/crossoverAtMilestone.html)
- Built-in methods supported in `TrialSimulator`
  ...
  - \[Combination test based on independent increment\] extended from
    [Jorgens et
    al. 2019](https://onlinelibrary.wiley.com/doi/10.1002/pst.1926).
    Vignette is under development.
