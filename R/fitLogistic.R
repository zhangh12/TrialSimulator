#' Fit generalized logistic regression model
#'
#' @description
#' Fit generalized logistic regression model on an binary endpoint.
#'
...
#' \code{fitLogistic('cfb', 'pbo', data, arm \%in\% c('pbo', 'low dose'), cfb > 0.5)},
...
#' \describe{
#' \item{\code{p}}{one-sided p-value for log odds ratio (placebo vs treated). }
#' \item{\code{info}}{the number of events of the endpoint in the subset. }
#' \item{\code{z}}{the z statistics of log odds ratio. }
#' }
#'
#' @export
#'
