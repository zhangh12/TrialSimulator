...
#' in action functions. It must not contain \code{'@'} or \code{';'}, which
#' are reserved for encoding the treatment switching history
#' (\code{regimen_trajectory}) of trials with a regimen.
