...
tumor_cfb_pbo <- endpoints(name = 'cfb', type = 'non-tte', 
                              readout = c(cfb = 6),
                              generator = rnorm, mean = .8, sd = 3.2)
orr_pbo <- endpoints(name = 'orr', type = 'non-tte', 
                        readout = c(orr = 2),
...
tumor_cfb_trt <- endpoints(name = 'cfb', type = 'non-tte', 
                              readout = c(cfb = 6), 
                              generator = rnorm, mean = -2.3, sd = 1.5)
orr_trt <- endpoints(name = 'orr', type = 'non-tte', 
                        readout = c(orr = 2), 
