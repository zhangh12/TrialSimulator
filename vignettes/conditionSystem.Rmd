...
which could be passed to the argument `trigger_condition` of `Event$new()`. 
...
## Note: 'pfs' is the name of the endpoint, i.e., Endpoint$new(name = 'pfs', ...)
## Note: 'pbo' is the name of the placebo arm, i.e., Arm$new(name = 'pbo', ...)
...
```{r eafho}
## Trigger a safety review when 10 severe adverse events observed in 2 months, 
## or 2 deaths in 6 months
##
## SAE and OS are both defined as a time-to-event endpoint by
## Endpoint$new(name = 'SAE', type = 'tte', ...)
## Endpoint$new(name = 'OS', type = 'tte', ...)
(eventNumber(endpoint = 'SAE', n = 10) & calendarTime(time = 2)) | 
  (eventNumber(endpoint = 'OS', n = 5) & calendarTime(time = 6))
```
