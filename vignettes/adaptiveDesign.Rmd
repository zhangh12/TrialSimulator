...
(`vrr_readout`) is also needed when creating the endpoint. Once all
...
dropout rate 20% per 12 months through `set_dropout`. By default, no
dropout if users do not specify one.
...
#'                placebo, low, high)
trial$set_dropout(rexp, rate = -log(1 - 0.2)/12)
```
