...
any place they want to summarize the trial later. The package can also
summarize commonly used metrics by default. For common design, the
package can carry out standard analysis, e.g., group sequential design
with combination test or graphical test as well, which would be
implemented later.

In summary, `TrialSimulator` abstracts the data generation and
management to allow user focus on the programming for statistical
