...
[Simulate Correlated Progression-Free Survival and Overall Survival as Endpoints in Clinical Trials](simulatePfsAndOs.html). 
...
to save running time. Parallelization is also supported by setting `n_workers`. 
