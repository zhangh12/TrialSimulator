...
`gestate`, `simdata`, etc. Once all endpoints are defined, an arm can be created 
...
#' define binary endpoint VRR
vrr <- Endpoint$new(
  name = 'vrr', type = 'binary', generator = rbinom,
  size = 1, prob = .4)
