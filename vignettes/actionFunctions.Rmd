...
-   `name`: the label of the milestone. A data snapshot at the triggering time can be retrieved by calling `trial$get_locked_data(<name>)`, where `<name>` is a 
placeholder of `name`. 
...
+------------------------------+--------------------------------------------------------+---------------------------------------------------------+
| Eliminate sub-population | `trial$update_generator()`                             | enrichment design                                       |
+------------------------------+--------------------------------------------------------+---------------------------------------------------------+
