...
| trial |       seed | milestone_time\_\<interim\> | n_events\_\<interim\>\_\<patient_id\> | n_events\_\<interim\>\_\<ep\> |  z_value | interim_decision | milestone_time\_\<final\> | n_events\_\<final\>\_\<patient_id\> | n_events\_\<final\>\_\<ep\> | decision | error_message |
|:------|-----------:|----------------------------:|--------------------------------------:|------------------------------:|---------:|:-----------------|--------------------------:|------------------------------------:|----------------------------:|:---------|:--------------|
| 123   | 1960520344 |                         6.8 |                                    35 |                            30 | 1.332786 | stop trial       |                      13.7 |                                 150 |                         150 | no-go    |               |
...
results—specifically, the trial must not be stopped at interim (i.e.,
`interim_decision == "add dose arms"`), and the function `go_nogo()`
...
| trial |       seed | milestone_time\_\<interim\> | n_events\_\<interim\>\_\<patient_id\> | n_events\_\<interim\>\_\<ep\> |    z_value | interim_decision | milestone_time\_\<final\> | n_events\_\<final\>\_\<patient_id\> | n_events\_\<final\>\_\<ep\> | decision | error_message |
|:------|-----------:|----------------------------:|--------------------------------------:|------------------------------:|-----------:|:-----------------|--------------------------:|------------------------------------:|----------------------------:|:---------|:--------------|
| 123   | 2006631926 |                         6.8 |                                    35 |                            30 |  1.0350983 | stop trial       |                      13.7 |                                 150 |                         150 | go       |               |
| 123   |  447300730 |                         6.8 |                                    35 |                            30 | -1.5191090 | stop trial       |                      13.7 |                                 150 |                         150 | no-go    |               |
| 123   | 1544385735 |                         6.8 |                                    35 |                            30 |  1.0954461 | stop trial       |                      13.7 |                                 150 |                         150 | no-go    |               |
| 123   | 2131809493 |                         6.8 |                                    35 |                            30 |  1.9364917 | add dose arms    |                      13.7 |                                 150 |                         150 | no-go    |               |
| 123   |  799237881 |                         6.8 |                                    35 |                            30 |  1.0954461 | stop trial       |                      13.7 |                                 150 |                         150 | no-go    |               |
| 123   | 1359695008 |                         6.8 |                                    35 |                            30 |  1.5256441 | stop trial       |                      13.7 |                                 150 |                         150 | no-go    |               |
| 123   | 2040133893 |                         6.8 |                                    35 |                            30 |  0.4330129 | stop trial       |                      13.7 |                                 150 |                         150 | no-go    |               |
| 123   |  715681929 |                         6.8 |                                    35 |                            30 |  1.5191090 | stop trial       |                      13.7 |                                 150 |                         150 | go       |               |
| 123   | 1222856748 |                         6.8 |                                    35 |                            30 |  1.5256441 | stop trial       |                      13.7 |                                 150 |                         150 | no-go    |               |
| 123   | 1512640951 |                         6.8 |                                    35 |                            30 |  1.9364930 | add dose arms    |                      13.7 |                                 150 |                         150 | go       |               |
